...
All files are committed under [`homework-2/docs/screenshots/`](screenshots/). Images below render once the `homework-22` branch is pushed.

### TDD iteration: tests first (RED) → implementation (GREEN)

**Step 1 — the tests already existed and were red.** The suites were written against stub services before any implementation; here they fail (19 failed / 2 passed):

![TDD red run — tests exist, no implementation yet](https://raw.githubusercontent.com/mgplaya/gen-ai-software-engineering/homework-22/homework-2/docs/screenshots/tdd-red-run.png)

**Step 2 — the code was added and the same tests went green.** The implementation was written module by module (classification → tickets → import) until the suite passed 56/56, 8/8 suites; assertions were never weakened:

![TDD green run — same suite after implementation](https://raw.githubusercontent.com/mgplaya/gen-ai-software-engineering/homework-22/homework-2/docs/screenshots/tdd_green_run.png)

### Test coverage — all 4 metrics >85% (required deliverable)

![Test coverage report](https://raw.githubusercontent.com/mgplaya/gen-ai-software-engineering/homework-22/homework-2/docs/screenshots/test_coverage.png)

### AI planning — approved plan (context + cleanup of the broken previous attempt)

![Approved plan: context](https://raw.githubusercontent.com/mgplaya/gen-ai-software-engineering/homework-22/homework-2/docs/screenshots/plan-approved-context.png)

### AI planning — execution order, verification, risks

![Approved plan: execution order](https://raw.githubusercontent.com/mgplaya/gen-ai-software-engineering/homework-22/homework-2/docs/screenshots/plan-approved-execution-order.png)

### AI planning — final plan with user decisions (TS keyword engine, pure TDD)

![Final plan with user decisions](https://raw.githubusercontent.com/mgplaya/gen-ai-software-engineering/homework-22/homework-2/docs/screenshots/plan-final-user-decisions.png)

### Agent pipeline table — who → does what (3 test-writers, 3 doc models, /code-review)

![Agent pipeline table](https://raw.githubusercontent.com/mgplaya/gen-ai-software-engineering/homework-22/homework-2/docs/screenshots/plan-agent-pipeline-table.png)

### Pipeline completion report — TDD stats, review findings, smoke test

![Pipeline completion report](https://raw.githubusercontent.com/mgplaya/gen-ai-software-engineering/homework-22/homework-2/docs/screenshots/pipeline-final-summary.png)
